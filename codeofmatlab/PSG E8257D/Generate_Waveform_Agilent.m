...
deviceObject = visa('agilent','TCPIP0::192.168.2.11::inst0::INSTR');
% deviceObject = gpib('agilent',8,19);
%deviceObject = tcpip('192.168.2.11');
...
fprintf(deviceObject, 'SOURce:FREQuency %.2f',freq);
% Set the source power
fprintf(deviceObject, 'POWer %d',amplitude);
